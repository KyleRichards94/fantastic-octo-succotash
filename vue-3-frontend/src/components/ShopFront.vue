<template>
    <div class="container" style="padding-top: 2%;">
        ...
        <div class="jumbotron"
            ...
            <h1 class="display-3" style="text-shadow:1px 2px white;font-weight:bold;;text-align: center;">Welcome, to the
                shop</h1>
            <hr class="my-4">
            <p class="lead"
                style="text-align:center;text-shadow:1px 1px white ;font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">
                Find your favourite 3D printers!</p>
        </div>
    ...
    <div class="row justify-content-md-center" style="padding-top: 2%;">
        <div class="card"
            ...
            <div class="card-body">
                <h5 class="card-title" style="text-align: center;">Want to see some cool designs you could be printing on
                your new printer!?</h5>
            <p class="card-text" style="text-align: center;"> Head over to our Community Hub and check them out!</p>
            <RouterLink class="btn btn-primary" to="/CommunityHub">Community Hub</RouterLink>
        </div>
    </div>
</div></template>
